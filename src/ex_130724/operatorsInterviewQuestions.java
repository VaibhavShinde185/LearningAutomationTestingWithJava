...
public class operatorsInterviewQuestions {
     ...
     * How do shift operators (<<, >>, >>>) work? Can you explain with examples?    --IGNORE
     * What is the difference between >> and >>> in Java?       --IGNORE
     * Why is ~ (bitwise NOT) called a complement operator? How does it work?       --IGNORE
     * How does Java handle implicit and explicit type casting with arithmetic operators?
     * What is Upcasting and Downcasting?
     * What is short-circuit evaluation in Java? How does it work with logical operators?       --IGNORE
     ...
     * How does the ^ (bitwise XOR) operator work, and where is it useful?      --IGNORE
     ...
     * What happens when performing bitwise operations on boolean values?       --IGNORE
